...
public class LoopCheckPostCondDialog extends HoareDialog implements Initializable {
	...
	private Hoare.Executer.LoopCheckPostCond_callback _callback;
	private BoolExp _boolExp;
	private SyntaxNode _progNode;
	private HoareCond _postInvariant;

	public LoopCheckPostCondDialog(Hoare.Executer.wlp_loop loop, Hoare.Executer.LoopCheckPostCond_callback callback) throws IOException {
