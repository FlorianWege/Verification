...
public class CompositionInitDialog implements Initializable {
	@FXML
	...
	private Hoare.Executer.CompositionStartInterface _callback;
	...
	public CompositionInitDialog(SyntaxTreeNode node, HoareCond postCond, Hoare.Executer.CompositionStartInterface callback, SyntaxTreeNode firstNode, SyntaxTreeNode secondNode) throws IOException {
		_node = node;
		_postCond = postCond;
		_callback = callback;
		...
		Scene scene = IOUtil.inflateFXML(new File("CompositionInitDialog.fxml"), this);
